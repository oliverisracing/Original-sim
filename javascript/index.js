...
//SEASON 3:
let alexiss3 = new Queen("Alexis Mateo",11,14,12,10,9,8,15,13,8,"AlexisS3");
...
let rajas3 = new Queen("Raja",9,11,14,12,15,14,10,7,18,"RajaS3");
let shangelas3 = new Queen("Shangela(S3)",11,11,11,8,2,7,11,10,7,"ShangelaS3");
...
let cynthialees9 = new Queen("Cynthia Lee Fontaine (S9)",5,4,6,5,6,5,6,7,5,"CynthiaS9");
...
let brooke = new Queen("Brooke Lynn Hytes", 8,12,10,15,15,15,15,9,12,"Brooke");
...
//SEASON 13
let denali = new Queen("Denali Foxx", 7, 10, 9, 13, 8, 10, 15, 10, 18,"Denali");
...
let utica = new Queen("Utica Queen", 6, 6, 6, 8, 13, 12, 10, 10, 9,"Utica");
...
//ALL STARS 2
let adoreas2 = new Queen("Adore Delano (AS2)", 9, 10, 11, 7, 6, 11, 9, 10, 10,"AdoreAS2")
let alaskaas2 = new Queen("Alaska Thunderfuck (AS2)", 14, 11, 10, 8, 10, 10, 10, 14, 9,"AlaskaAS2");
...
let detoxas2 = new Queen("Detox (AS2)", 9, 10, 13, 10, 11, 13, 12, 10, 13,"DetoxAS2");
...
let jaremyas2 = new Queen("Jaremy Carey (AS2)", 8, 10, 11, 9, 13, 15, 10, 11, 8,"JaremyAS2");
let roxxxyas2 = new Queen("Roxxxy Andrews (AS2)", 8, 10, 7, 10, 9, 14, 15, 10, 6,"RoxxxyAS2");
let tatias2 = new Queen("Tatianna (AS2)", 10, 13, 10, 12, 9, 8, 15, 10, 9,"TatiannaAS2");
let allstars_2 = [adoreas2, alaskaas2, alyssaeas2, cocoas2, detoxas2, gingeras2, katyaas2, jaremyas2, roxxxyas2, tatias2];
//ALL STARS 3
let ajaas3 = new Queen("Aja Labeija (AS3)", 10, 11, 12, 13, 12, 12, 10, 11, 13,"AjaAS3");
let bebeas3 = new Queen("Bebe Zahara Benet (AS3)", 9, 8, 10, 11, 9, 7, 13, 14, 16,"BebeAS3");
let delaas3 = new Queen("BenDeLaCreme (AS3)",12, 12, 12, 12, 12, 12, 8, 12, 15,"BendelaAS3");
...
let shangelaas3 = new Queen("Shangela (AS3)", 11, 12, 13, 12, 6, 10, 12, 12, 11,"ShangelaAS3");
let thorgy = new Queen("Thorgy Thor (AS3)", 10, 11, 8, 7, 12, 11, 7, 8, 9,"ThorgyAS3");
let trixieas3 = new Queen("Trixie Mattel (AS3)", 10, 8, 9, 7, 8, 9, 7, 10, 8,"TrixieAS3")
let allstars_3 = [ajaas3, bebeas3,delaas3,chichias3,kennedyas3,milkas3,morganas3,shangelaas3, thorgy,trixieas3];
//ALL STARS 4
let farrahas4 = new Queen("Farrah Moan (AS4)", 6, 5, 4, 5, 8, 10, 8, 6, 2,"FarrahAS4");
let giagas4 = new Queen("Gia Gunn (AS4)", 6, 5, 8, 8, 9, 10, 13, 8, 3,"GiaAS4");
let jasmineas4 = new Queen("Jasmine Masters (AS4)", 5, 6, 6, 6, 6, 6, 9, 7, 6,"JasmineAS4");
let latriceas4 = new Queen("Latrice Royale (AS4)", 10, 11, 12, 10, 8, 7, 9, 8, 11,"LatriceAS4");
let manilaas4 = new Queen("Manila Luzon (AS4)", 10, 12, 13, 12, 11, 8, 14, 13, 9,"ManilaAS4");
let monetas4 = new Queen("Monét X Change (AS4)", 10, 11, 13, 10, 7, 9, 14, 11, 14,"MonetAS4");
let moas4 = new Queen("Mo Heart (AS4)", 12, 11, 13, 10, 9, 12, 10, 11, 6,"MoAS4");
let naomias4 = new Queen("Naomi Smalls (AS4)", 9, 10, 10, 12, 14, 13, 15, 11, 11,"NaomiAS4");
let tttas4 = new Queen("Trinity The Tuck (AS4)", 12, 13, 14, 11, 11, 14, 10, 8, 9,"TrinityAS4");
let valentinas4 = new Queen("Valentina (AS4)", 10, 9, 8, 9, 12, 11, 15, 11, 17,"ValentinaAS4");
let allstars_4 = [farrahas4, giagas4, jasmineas4, latriceas4, manilaas4, monetas4, moas4, naomias4, tttas4, valentinas4];
//ALL STARS 5
let alexisas5 = new Queen("Alexis Mateo (AS5)", 12, 11, 10, 10, 11, 8, 12, 10, 11,"AlexisAS5");
...
let indiaas5 = new Queen("India Ferrah (AS5)", 7, 7, 7, 7, 7, 10, 12, 7, 3,"IndiaAS5");
let jujubeeas5 = new Queen("Jujubee (AS5)", 11, 10, 9, 11, 8, 13, 10, 10, 11,"JujubeeAS5");
let mariahas5 = new Queen("Mariah Paris Balenciaga (AS5)", 9, 10, 7, 9, 7, 13, 11, 9, 8,"MariahAS5");
let mayhemas5 = new Queen("Mayhem Miller (AS5)", 10, 11, 12, 8, 9, 11, 13, 8, 9,"MayhemAS5");
let mizas5 = new Queen("Miz Cracker (AS5)", 12, 11, 14, 10, 9, 9, 7, 12, 8,"MizAS5");
let onginaas5 = new Queen("Ongina (AS5)", 8, 7, 9, 7, 10, 12, 6, 7, 7,"OnginaAS5");
let sheaas5 = new Queen("Shea Coulée (AS5)", 10, 11, 13, 14, 12, 13, 14, 10, 16,"SheaAS5");
let allstars_5 = [alexisas5, blairas5, derrickas5, indiaas5, jujubeeas5, mariahas5, mayhemas5, mizas5, onginaas5, sheaas5];
//ALL STARS 6
let akeriaas6 = new Queen("Akeria C. Davenport (AS6)", 10, 11, 7, 9, 12, 15, 10, 8, 9,"AkeriaAS6");
let eurekaas6 = new Queen("Eureka! (AS6)", 12, 11, 13, 12, 10, 9, 11, 8, 11,"EurekaAS6");
let gingeras6 = new Queen("Ginger Minj (AS6)", 13, 14, 15, 9, 8, 5, 13, 12, 11,"GingerAS6");
let janas6 = new Queen("Jan(AS6)", 8, 9, 8, 10, 12, 12, 4, 10, 10,"JanAS6");
let jigglyas6 = new Queen("Jiggly Caliente (AS6)", 10, 9, 11, 9, 5, 7, 10, 6, 5,"JigglyAS6");
let kylieas6 = new Queen("Kylie Sonique Love (AS6)", 12, 11, 13, 12, 10, 13, 14, 9, 13,"KylieAS6");
let pandoraas6 = new Queen("Pandora Boxx (AS6)", 11, 12, 9, 7, 6, 8, 7, 10, 8,"PandoraAS6");
let rajahas6 = new Queen("Ra'Jah O'Hara (AS6)", 12, 11, 13, 12, 11, 13, 15, 12, 11,"RajahAS6");
let scarletas6 = new Queen("Scarlet Envy (AS6)", 9, 11, 10, 8, 9, 13, 8, 12, 9,"ScarletAS6");
let serenaas6 = new Queen("Serena ChaCha (AS6)", 6, 6, 7, 10, 9, 13, 8, 6, 3,"SerenaAS6");
let silkyas6 = new Queen("Silky Nutmeg Ganache (AS6)", 12, 11, 9, 10, 9, 8, 15, 10, 9,"SilkyAS6");
let trinityas6 = new Queen("Trinity K. Bonet (AS6)", 12, 11, 8, 13, 12, 13, 10, 11, 16,"TrinityAS6");
let yaraas6 = new Queen("Yara Sofia (AS6)", 9, 10, 11, 13, 11, 12, 10, 11, 10,"YaraAS6");
...
//ALL STARS 7
let jaidaas7 = new Queen("Jaida Essence Hall (AW)", 10, 11, 10, 12, 12, 14, 12, 13, 13,"JaidaAS7");
let jinkxas7 = new Queen("Jinkx Monsoon (AW)", 14, 12, 15, 10, 11, 11, 13, 12, 13,"JinkxAS7");
let monetas7 = new Queen("Monét X Change (AW)", 11, 12, 13, 14, 10, 12, 14, 11, 20,"MonetAS7");
let rajaas7 = new Queen("Raja (AW)", 14, 11, 12, 11, 14, 13, 12, 11, 13,"RajaAS7");
let sheaas7 = new Queen("Shea Coulée (AW)", 11, 12, 13, 12, 12, 14, 14, 13, 25,"SheaAS7");
let vivas7 = new Queen("The Vivienne (AW)", 14, 12, 11, 10, 13, 12, 14, 13, 15,"VivienneAS7");
let trinityas7 = new Queen("Trinity The Tuck (AW)", 14, 14, 11, 13, 14, 14, 12, 12, 11,"TrinityAS7");
let yvieas7 = new Queen("Yvie Oddly (AW)", 12, 11, 10, 15, 12, 12, 14, 15, 15,"YvieAS7");
...
let veronicas3 = new Queen('Veronica Green (S3)', 9, 10, 11, 8, 6, 7, 13, 10, 10,"VeronicaS3");
...
//UKVSTW
let bagauk = new Queen("Baga Chipz (UK)", 11, 10, 14, 7, 6, 7, 9, 12, 10,"BagaUKVSTW");
let bluuk = new Queen("Blu Hydrangea (UK)", 10, 11, 13, 9, 8, 14, 12, 11, 11,"BluTW");
...
let jimbouk = new Queen("Jimbo (UK)", 14, 13, 12, 7, 13, 12, 4, 10, 9,"JimboUKVSTW");
...
let victoriacan = new Queen("Victoria Scone (CA)", 13, 12, 13, 9, 11, 9, 11, 11, 8,"VictoriaCVSTW");
let vanitycan = new Queen("Vanity Milan (CA)", 9, 8, 14, 9, 10, 12, 14, 10, 16, "VanityCVSTW");
let ritacan = new Queen("Rita Baga (CA)", 12, 11, 8, 7, 10, 9, 10, 11, 9, "RitaCVSTW");
let icesiscan = new Queen("Icesis Couture (CA)", 11, 13, 13, 15, 12, 15, 14, 13, 13, "IcesisCVSTW");
let anitacan = new Queen("Anita Wiglit (CA)", 10, 8, 7, 8, 10, 10, 8, 11, 7, "AnitaCVSTW");
let kendallcan = new Queen("Kendall Gender (CA)", 7, 11, 10, 6, 8, 9, 10, 8, 8, "KendallCVSTW");
let stephaniecan = new Queen("Stephanie Prince (CA)", 5, 6, 3, 8, 6, 12, 10, 8, 7,"StephanieCVSTW");
let silkycan = new Queen("Silky Nutmet Ganache (CA)", 13, 12, 11, 10, 11, 9, 15, 13, 11, "SilkyCVSTW");
